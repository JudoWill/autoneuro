# AUTOGENERATED! DO NOT EDIT! File to edit: 01_domains.ipynb (unless otherwise specified).
...
class MemoryDomain(AbstractDomain):
    ...
    def from_defaults(root_data = 'data/'):
        ...
        heaton_normer = core.ScaledRegressionTransform.from_yaml(['data/norms/norman/heaton_AA_BVMTdelay.yaml',
                                                                  'data/norms/norman/heaton_AA_BVMTtotalrecall.yaml',
                                                                  'data/norms/norman/heaton_White_BVMTdelay.yaml',
                                                                  'data/norms/norman/heaton_White_BVMTtotalrecall.yaml',
